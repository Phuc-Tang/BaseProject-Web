                    ...
                    <form action=" {{URL::to('/save-category-product')}} " method="post">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="category_alias" class="form-control" placeholder="Tên bí danh...">
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label>Mô tả:</label>
                                <textarea name="category_desc" class="form-control" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
